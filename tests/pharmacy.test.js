...
app.get('/pharmacy/prescription/:prescriptionId', authenticate, roleGuard('PHARMACIST'), (req, res) => {
  try {
...
// Issue prescription
app.post('/pharmacy/prescription/:prescriptionId/issue', authenticate, roleGuard('PHARMACIST'), (req, res) => {
  try {
    const { prescriptionId } = req.params;
    const prescription = prescriptions.find(p => p.prescriptionId === prescriptionId);
