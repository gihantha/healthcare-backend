...
app.post('/patient/register', authenticate, roleGuard('NURSE', 'MODERATOR'), (req, res) => {
  ...
  res.status(201).json({ success: true, data: { patientId: patient.patientId } });
});

app.post('/visit/create', authenticate, roleGuard('NURSE', 'MODERATOR'), (req, res) => {
